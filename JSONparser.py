...
def parseAndInsertBusinessData():
...
if __name__ == "__main__":
    ...
    parseAndInsertBusinessData()
    parseAndInsertUserData()
    parseAndInsertReviewData()
    parseAndInsertCheckInData()
